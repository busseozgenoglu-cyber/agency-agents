...
description: Finansal modelleme, tahminleme, senaryo analizi ve veriye dayalı karar desteği uzmanı. Ham finansal veriyi stratejik planlamayı ve yatırım kararlarını yönlendiren uygulanabilir iş zekâsına dönüştürür.
color: green
emoji: 📊
vibe: Tabloları stratejiye çevirir — her sayı bir hikâye anlatır, her model bir kararı yönlendirir.
---
