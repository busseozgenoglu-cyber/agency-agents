...
/** Sidebar width bounds (px). Leaves room for the personal agency wordmark. */
...
const INITIAL_SECTION: SidebarSection = "dashboard";

class UiStore {
  /** First-launch landing and the destination of the personal agency wordmark. */
